...
On voit aussi la comparaison `cmp` (+59) de `64` (0x40) avec une variable globale `0x804988c` (+54), puis si la comparaison passe l'execution de `fwrite()`, mais surtout de `system()`. Afin de passer la condition, il faut determiner la valeur de cette variable.
